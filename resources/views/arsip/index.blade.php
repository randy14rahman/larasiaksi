...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <table id="datatable-arsip-surat-masuk" class="table table-stripped table-responsive" style="display: inline-table; width:100%;"></table>
        </div>
    </div>
    <div class="card">
        <div class="card-header border-0">
        ...
        <div class="card-body">
            <table id="datatable-arsip-surat-keluar" class="table table-stripped table-responsive"style="display: inline-table; width:100%;"></table>
        </div>
    </div>
