    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable-1" class="table table-striped table-bordered table-responsive" style="width:100%"></table>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modal-add-user">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form-add-user" novalidate="novalidate"  name="form-add">
                    @csrf
    ...
    <div class="modal fade" id="modal-edit-user">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form-edit-user" novalidate="novalidate" name="form-edit">
                    @csrf
                    <div class="modal-body">
