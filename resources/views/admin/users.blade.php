            ...
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="card-tools">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modal-add-user">Add
                            user</button>
                    </div>
                </div>
            </div>
...
$(() => {
    ...
    $('#modal-add-user').on('show.bs.modal', (e) => {
        ...
        $('#form-add-user button[type="submit"]').removeClass('btn-success btn-secondary').addClass(
            'btn-primary').text('Create');
    });
    $('#modal-edit-user').on('show.bs.modal', (e) => {
        $('#form-edit-user button[type="submit"]').prop('disabled', false);
        $('#form-edit-user button[type="submit"]').removeClass('btn-success btn-secondary').addClass(
    ...
    $.ajax({
        ...
        success: (res) => {
            ...
            if (res.status == 1) {
                ...
                $('#form-add-user button.btn-submit').removeClass('btn-secondary').addClass('btn-success')
                    .text('Success');
    ...
    $.ajax({
        ...
        success: (res) => {
            ...
            if (res.status == 1) {
                ...
                $('#form-edit-user button.btn-submit').removeClass('btn-secondary').addClass('btn-success')
                    .text('Success');
